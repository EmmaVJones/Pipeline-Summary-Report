...
render_connect_email(input = "PipelineSummaryReportBlastulaEmailSimple.Rmd") %>%
  attach_connect_email(
    subject = "Pipeline Summary Report From DEQ RStudio Connect Server",
    attach_output = TRUE#,
